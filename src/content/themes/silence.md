---
title: Silence
subtitle: The apophatic current. The recognition reached not by adding words but by setting them down. Common to the Cloud author, Eckhart, the Theologia Germanica, and the silent satsangs of Ramana.
description: "The contemplative recognition that what is sought is found by setting down what one knows, not by adding more knowledge to it. The apophatic strand within the Christian tradition (the Cloud, Eckhart, the Theologia Germanica) and the silent satsangs of the Indian masters (Ramana, Robert Adams) point to the same recognition: that beyond all images and concepts, what one is, is already the case."
order: 3
imagePrompt: A still candle burning with a steady warm flame in a vast dark stone hall, the rest of the hall receding into deep cosmic blue shadow, no other light, no people, contemplative atmospheric composition, painterly minimal style
image: /images/theme-silence.jpg
leadQuote:
  text: Silence is unceasing eloquence. It is the best language.
