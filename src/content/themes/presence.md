---
title: Presence
subtitle: The recognition that what is sought is already and immediately here. Common to Brother Lawrence, John Butler, the Cloud author, and most modern nondual teachers.
description: The teaching that the awareness one is searching for is not later, not elsewhere, not gained by practice but already and immediately the case. Brother Lawrence reduced the contemplative life to a single instruction, the practice of the presence of God. The Cloud author called it the work, John Butler simply the Light. In the modern voices it becomes recognition without remainder.
order: 2
