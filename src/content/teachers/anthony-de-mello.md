...
imagePrompt: Photorealistic portrait of Anthony de Mello as an Indian Jesuit priest in his fifties, dark hair flecked with grey, warm intelligent face, gentle smile, wearing a simple black clerical shirt, soft warm afternoon light, contemplative atmosphere reminiscent of mid-1980s photographs from Lonavla retreat centre, square composition
image: /images/teacher-anthony-de-mello.jpg
sourceUrl: https://en.wikipedia.org/wiki/Anthony_de_Mello
leadQuote:
  text: 'You are asleep. You do not see what is in front of you. You take yourself to be the labels, the stories, the conditioning, but you are not.'
  attribution: 'Anthony de Mello'
themes:
  - presence
  - self-inquiry
related:
